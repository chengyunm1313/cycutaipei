...
export default function AdminFaqCustomListPage() {
	...
	useEffect(() => {
		fetchSiteContents({ type: 'faq_page' })
			.then(setPages)
			.catch((error) => {
				console.error('載入常見問題頁面失敗:', error);
			})
	...
	return (
		<div className='max-w-4xl mx-auto space-y-4'>
			<h1 className='text-2xl lg:text-3xl font-extrabold text-text tracking-tight'>網站管理 - 常見問題 / 自訂義頁面</h1>
