...
export const SITE_CACHE_TAGS = {
	...
	academyCategories: 'site:academy-categories',
...
export const SITE_REVALIDATE_PATH_TARGETS: RevalidatePathTarget[] = [
	...
	{ path: '/academy', type: 'page' },
	{ path: '/academy/[slug]', type: 'page' },
	...
	{ path: '/admin/academy', type: 'page' },
	{ path: '/admin/academy/[id]', type: 'page' },
	{ path: '/admin/academy-categories', type: 'page' },
	{ path: '/admin/academy-categories/[id]', type: 'page' },
...
const URL_SCOPE_RULES: Array<{ pattern: RegExp; scopes: SiteCacheScope[] }> = [
	...
	{ pattern: /\/api\/academy(?:\/|$)/, scopes: ['academy'] },
	{ pattern: /\/api\/academy-categories(?:\/|$)/, scopes: ['academyCategories'] },
