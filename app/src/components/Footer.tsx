...
export default async function Footer() {
	...
	let contactPhone = '+886 2 1234 5678';
	let contactEmail = 'contact@example.com';
	let contactAddress = '台灣台北市中山區';
	let copyright = '';
					...
					<div>
						...
						<ul className='space-y-3'>
							...
							<li className='flex items-start gap-2.5'>
								...
								<span className='text-sm text-gray-400'>{contactPhone || '+886 2 1234 5678'}</span>
							</li>
						</ul>
					</div>
				</div>
